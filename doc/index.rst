Sequana downsampling pipeline documentation
#####################################################

|version|, |today|, status: production

The **downsampling** pipeline is a `Sequana <https://github.com/sequana/sequana>`_ pipeline. You can find the source code 
on  `https://github.com/sequana/sequana_downsampling <https://github.com/sequana/sequana_downsampling/>`_. Would you have issues
...
The Sequana downsampling pipeline
==============================================
